...
public class TestSpringBootDefaultShutdown {
    private final Logger logger = LoggerFactory.getLogger(TestSpringBootDefaultShutdown.class);
    ...
    @Disabled
    @Test
    public void testSpringBootDefaultShutdown() throws IOException, InterruptedException, ExecutionException {
        /*
        ...
        /*
            sleep a bit to give OS scheduler a chance to give the pal-tracker process
            some time to flush logs.
        */
        sleep(2000);
